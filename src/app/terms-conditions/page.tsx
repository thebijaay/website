  ...
  return (
    <Column maxWidth="m" gap="l" paddingY="xl">
      ...
      <Column gap="m">
        ...
        <Text variant="body-default-m">
          The content on this website, including text, images, graphics, and code, is the property
          of {person.name} unless otherwise stated. Unauthorized use or reproduction of this content
      ...
      <Column gap="m">
        ...
        <Text variant="body-default-m">
          ...
          only for lawful purposes and in a manner that does not infringe upon or restrict the use
      ...
      <Column gap="m">
        ...
        <Text variant="body-default-m">
          ...
          efforts are made to ensure accuracy, no guarantees are made regarding completeness,
      ...
      <Column gap="m">
        ...
        <Text variant="body-default-m">
          {person.name} shall not be liable for any direct, indirect, incidental, or consequential
